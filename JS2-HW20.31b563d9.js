...
})({"2SUgb":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 62533;
...
form.addEventListener("submit", async (e)=>{
    ...
    try {
        if (editingPostId) {
            await (0, _axiosDefault.default).put(`${API_URL}/${editingPostId}`, {
                title,
                content
            });
            editingPostId = null;
        } else await (0, _axiosDefault.default).post(API_URL, {
            title,
            content
        });
        form.reset();
...
async function loadPosts() {
    try {
        const res = await (0, _axiosDefault.default).get(API_URL);
        container.innerHTML = "";
        ...
        <h2>${post.title}</h2>
        <p>${post.content}</p>
        <button class="edit-btn" data-id="${post.id}">\u{420}\u{435}\u{434}\u{430}\u{433}\u{443}\u{432}\u{430}\u{442}\u{438}</button>
      `;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["2SUgb","a0t4e"], "a0t4e", "parcelRequirea89c", {})

//# sourceMappingURL=JS2-HW20.31b563d9.js.map
